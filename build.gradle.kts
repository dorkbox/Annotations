...
GradleUtils.load {
    ...
    description = "Extremely fast, lightweight annotation scanner for the classpath, classloader, or files for Java 25"
    name = "Annotations"
    version = "3.3"
    ...
    url = "https://git.dorkbox.com/dorkbox/Annotations"
